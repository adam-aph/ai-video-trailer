...
- [ ] **Phase 1: Ingestion Pipeline and CLI Shell** - FFmpeg proxy creation, keyframe extraction, subtitle parsing, and the CLI entry point with progress and error handling
- [ ] **Phase 2: Manifest Contract, Vibes, and Conform** - Pydantic manifest schema, all 18 vibe profiles with LUTs, high-bitrate FFmpeg conform pipeline, and --review workflow
...
|-------|----------------|--------|-----------|
| 1. Ingestion Pipeline and CLI Shell | 4/5 | In Progress|  |
