...
- [x] **STRC-02**: System assigns each extracted clip to a narrative zone: BEGINNING, ESCALATION, or CLIMAX
...
- [x] **EORD-04**: A deliberate silence segment (3-5s black video + muted audio) is inserted at the Act 2→3 boundary
